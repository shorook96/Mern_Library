...
const GetBooks = (data) => {
  return fetch('http://localhost:5000/' + 'books/fulldata/' + data).then(
    ...
    return (
      <div class="booksofauthor">
        ...
        <div class="userRating">
          <StarRating stars={li.rating} />{' '}
          <span class="userRatingnum">{li.rating}</span>{' '}
        </div>
      ...
      <div>
        ...
        <div class="beside">
          ...
          <h6 class="authorname">
            ...
            <Link
              style={{ color: '#FD5' }}
              to={'/Author/' + BooksInfo.authorId}
            >
              {' '}
              {BooksInfo.authorName}{' '}
            </Link>{' '}
          </h6>
          ...
          <div class="rating">
            ...
            <span class="userRatingnum">
              {' '}
              {BooksInfo.totalrating} stars - {BooksInfo.numberrating} ratings
            </span>
          </div>
