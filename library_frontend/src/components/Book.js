...
export default function Book(props) {
    // state = { im : "https://prod-images.tcm.com/Master-Profile-Images/WaltDisney.jpg" }
        ...
        return (
        <div  class="booksofauthor"><img class=" userimg" src="https://upload.wikimedia.org/wikipedia/commons/9/99/Sample_User_Icon.png" width="70px" height="70px"></img> 
        
        {li.username}
        <div class="userRating"><StarRating/> <span class="userRatingnum">{li.rating}</span> </div>
    ...
    <div class="parentContainer">
        ...
        <div>
            ...
            <div class="ratingg"><StarRating/></div>
            </div>
            <div class="beside">
